...
export default function Timeline({ scan }) {
    return (
                    ...
                    </div>
                    {
                        scan.map(eachScan => (
                            <div class="scan-div">
                                <div class="dots">
                                    <div class="dot"></div>
                                    <div class="dot-line">_______</div>
                                </div>
                                <div class="right-summary">
                                    <div class="curr-status">{eachScan.status_detail}</div>
                                    <div class="status-date">{eachScan.time.split(" ")[0]}</div>                            
                                    <div class="status-time">{eachScan.time.split(" ")[1]}</div>
                                </div>
                            </div>
                        ))
                    }
